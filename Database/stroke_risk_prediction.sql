...
--
-- Host: localhost
-- Generation Time: Aug 16, 2022 at 01:11 PM
...
--
-- Database: `stroke_risk_prediction`
--
CREATE DATABASE IF NOT EXISTS `stroke_risk_prediction` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `stroke_risk_prediction`;
...
(1, 'Harish', 'Harish123@gmail.com', 'Harish', '9535866270', 'India', 'Karnataka', 'Bangalore', '#829,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#892,8th Cross,Viajayanagr', 'Male');
...
(182, 'SVM', '62.16216216216216'),
(183, 'Logistic Regression', '62.16216216216216'),
(184, 'Decision Tree Classifier', '62.16216216216216');
...
--
-- Table structure for table `remote_user_stroke_risk_prediction_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_stroke_risk_prediction_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idn` varchar(300) NOT NULL,
  `gender` varchar(300) NOT NULL,
  `age` varchar(300) NOT NULL,
  `hypertension` varchar(300) NOT NULL,
  `heart_disease` varchar(300) NOT NULL,
  `ever_married` varchar(300) NOT NULL,
  `work_type` varchar(300) NOT NULL,
  `Residence_type` varchar(300) NOT NULL,
  `avg_glucose_level` varchar(300) NOT NULL,
  `bmi` varchar(300) NOT NULL,
  `smoking_status` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_stroke_risk_prediction_type`
--

INSERT INTO `remote_user_stroke_risk_prediction_type` (`id`, `idn`, `gender`, `age`, `hypertension`, `heart_disease`, `ever_married`, `work_type`, `Residence_type`, `avg_glucose_level`, `bmi`, `smoking_status`, `Prediction`) VALUES
(1, '2e98e30e0e5ffd1f8475255eaa2cee8891bd4ee5', 'Female', '49', '0', '0', 'Yes', 'Private', 'Urban', '171.23', '34.4', 'smokes', 'More Risk'),
(2, '60c409717bb1aec593d0411118e2975fb9b6139d', 'Male', '81', '0', '0', 'Yes', 'Private', 'Urban', '72.81', '26.3', 'never smoked', 'No Risk'),
(3, '0f5888442a92665b65f719dac5712fd287f842b8', 'Female', '80', '1', '0', 'Yes', 'Self-employed', 'Urban', '68.56', '26.2', 'Unknown', 'More Risk'),
(4, 'a080640d17fb8db7f8bf5b0eebb8cf24c8396aae', 'Female', '78', '0', '0', 'Yes', 'Private', 'Rural', '235.63', '32.3', 'never smoked', 'More Risk'),
(5, '8db2b8c1236bfb85a942a1e45c3c634ad937f34b', 'Female', '68', '0', '0', 'No', 'Govt_job', 'Urban', '82.1', '27.1', 'Unknown', 'More Risk');
