...
urlpatterns = [
    ...
    url(r'^Predict_Stroke_risk_Prediction_Type/$', remoteuser.Predict_Stroke_risk_Prediction_Type, name="Predict_Stroke_risk_Prediction_Type"),
    ...
    url(r'^View_Stroke_Risk_Prediction_Type_Ratio/$', serviceprovider.View_Stroke_Risk_Prediction_Type_Ratio, name="View_Stroke_Risk_Prediction_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Stroke_Risk_Prediction_Type/$', serviceprovider.View_Stroke_Risk_Prediction_Type, name="View_Stroke_Risk_Prediction_Type"),
